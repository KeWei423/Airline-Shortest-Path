...
int main()
{
    string routeInfo[9], line,
           input = "/home/allen/School/CS8/finaldata/Resources/RAW/routes.dat";
    QFile out("/home/allen/School/CS8/finaldata/Resources/XML/routes.xml");
    ...
    out.close();
    in.close();
    cout<<"Finished creating routes XML"<<endl;
    return 0;
}
