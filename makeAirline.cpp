...
int main()
{
    string line, airlineInfo[8],
           input = "/home/allen/School/CS8/finaldata/Resources/RAW/airlines.dat";
    QFile out("/home/allen/School/CS8/finaldata/Resources/XML/airlines.xml");
    ...
    while(getline(in, line))
    {
        ...
        if(airlineInfo[0] == "-1" || airlineInfo[3] == "-"  || airlineInfo[4] == "N/A" ||
         airlineInfo[7] == "N")
            continue;
    ...
    in.close();
    out.close();
    cout<<"Finished creating airlines XML"<<endl;
    return 0;
}
